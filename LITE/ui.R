      ...
      fluidRow(
        ...
        column(4,
               ...
               textInput('pcr_mm_liq',
                         ...
                         value = "MasterMix Free Multi Rapid Disp"),
        ...
        column(4,
               ...
               numericInput('pcr_n_tip_reuse',
                            label = "PCR mastermix: number of tip reuses for multi-dispense",
                            value = 4),
               numericInput('pcr_n_multi_disp',
                            label = "PCR mastermix: number of multi-dispenses per tip (more multi-disp = more extra volume needed)",
                            value = 6)
        )
      )
    ),
