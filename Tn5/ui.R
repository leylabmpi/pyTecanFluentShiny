    ...
    tabPanel("Description", 
      fluidRow(
        column(12,
               ...
               h6('The sample concentrations (numeric value; units=ng/ul)'),
    ...
    tabPanel("Reagents", 
      fluidRow(
        column(4,
               ...
               numericInput('min_sample_volume',
                            label = "Min. possible sample volume per tag. rxn",
                            value = 1.0, min = 0, max = 100),               
               numericInput('max_sample_volume',
                            label = "Max. possible sample volume per tag. rxn",
                            value = 10.0, min = 1, max = 100),
               numericInput('target_sample_ng',
                            label = "Target (optimal) amount of DNA (ng) used per rxn",
                            value = 5.0, min = 0, max = 100),  
               numericInput('buffer_dilution',
                            label = "Fold-dilution of buffer (1=undiluted, 10=1:10 dilution, 100=1:100 dilution)",
        ...
        column(4,
               ...
               selectInput('pcr_mm_labware_type',
                           label = "Labware type for PCR mastermix",
                           choices = c('25ml trough (in 100ml trough)' = '25ml_1 waste',
                                       '1.5ml Eppendorf tube' = '1.5ml Eppendorf waste',
                                       '2ml Eppendorf tube' = '2ml Eppendorf waste',
                                       '5ml Eppendorf tube' = '5ml Eppendorf waste',
        ...
        column(4,
               ...
               selectInput('water_labware_type',
                           label = "Labware type for water",
                           choices = c('25ml trough (in 100ml trough)' = '25ml_1 waste',
                                       '1.5ml Eppendorf tube' = '1.5ml Eppendorf waste',
                                       '2ml Eppendorf tube' = '2ml Eppendorf waste',
                                       '5ml Eppendorf tube' = '5ml Eppendorf waste',
